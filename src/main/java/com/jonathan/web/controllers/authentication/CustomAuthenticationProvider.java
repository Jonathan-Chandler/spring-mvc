...
////      if (user == null)
////      {
////        logger.info("Fail to find username: " + username);
...
////        {
////          logger.info("Password did not match: '" + password + "' Encoded password: " + user.getPassword());
////          return null;
////        }
////        else
////        {
////          logger.info("Input password matched: " + password);
...
////    catch (Exception e)
////    {
////      logger.info("User repo throws exception");
////      throw new BadCredentialsException("Fail to find username");
////    }
////  }
////
