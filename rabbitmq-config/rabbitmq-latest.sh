...
#sudo docker run -p 5672:5672 -p 15672:15672 -p 61613:61613 rabbitmq-custom
sudo docker run -d -p 5672:5672 -p 15672:15672 -p 61613:61613 rabbitmq:3-management
