...
export default function LocalGame () {
    ...
    const makeAiMove = useCallback(async () =>
    {
		if (moveCount % 2 === 1)
		{
			...
			handleClick(remainingSquares[randomIndex])
		}
	}, [handleClick, moveCount, boardSquares]);

	// update winner / move count
    useEffect(() => 
    {
		let tempCount = 0;
		...
		// update ai player move
		if (!winner && tempCount % 2)
			makeAiMove()

    }, [winner, moveCount, makeAiMove, boardSquares]);
